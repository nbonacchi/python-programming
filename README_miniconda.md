...
## Using UV
Install git  
Install vscode (+ Install vs code extensions for python)  
Install uv for your platform : https://docs.astral.sh/uv/getting-started/installation/#installation-methods    

open terminal app (whichever you have)  
cd into documents  
git clone https://github.com/nbonacchi/python-programming.git  
cd python-programming  
